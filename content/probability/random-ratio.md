...
$$P(E) = \int_0^{1/2} (2q - q) \, dq + \int_{1/2}^1 (1 - q) \, dq$$
...
PS - A similar integration is involved in the problem [Random-Angle-II](/fun/probability/random-angle-ii). Check it out for a more detailed explaination incase of any confusions!.